...
nikpay <- read.table("gmm_diff.nikpay.to_plot.gz")
lambert <- read.table("gmm_diff.lambert.to_plot.gz")
liu <- read.table("gmm_diff.liu.to_plot.gz")
mich <- read.table("gmm_diff.michailidou.to_plot.gz")
lopez <- read.table("gmm_diff.lopez-isac.to_plot.gz")
mahajan <- read.table("gmm_diff.mahajan.to_plot.gz")
malik <- read.table("gmm_diff.malik.to_plot.gz")
chris <- read.table("gmm_diff.christophersen.to_plot.gz")
