#import all superclump diff data

nikpay <- read.table("super_diff.nikpay.to_plot.gz")
lambert <- read.table("super_diff.lambert.to_plot.gz")
liu <- read.table("super_diff.liu.to_plot.gz")
mich <- read.table("super_diff.michailidou.to_plot.gz")
lopez <- read.table("super_diff.lopez-isac.to_plot.gz")
mahajan <- read.table("super_diff.mahajan.to_plot.gz")
malik <- read.table("super_diff.malik.to_plot.gz")
chris <- read.table("super_diff.christophersen.to_plot.gz")
