...
PCA <- read.table("PCA_components.lopez-isac.to_plot.gz")
weights <- read.table("weights.lopez-isac.to_plot.gz")
means <- read.table("means.lopez-isac.to_plot.gz")
probs <- read.table("probabilities.lopez-isac.to_plot.gz")
rsids <- read.table("pca_rsids.lopez-isac.to_plot.gz", stringsAsFactors = F)
#supersnps <- read.table("superclump.snps.lopez-isac.to_plot", stringsAsFactors = F)
annot <- read.table("annot.lopez-isac.to_plot.gz")
annot_names <- read.table("annot_names.lopez-isac.to_plot.gz", stringsAsFactors = F)
...
final_weights <- read.table("total_weights.lopez-isac.to_plot.gz", stringsAsFactors = F)
PGS_annot <- read.table("PGS_annot_sums.lopez-isac.to_plot.gz", stringsAsFactors = F)
superclump_annot <- read.table("super_sums.lopez-isac.to_plot.gz", stringsAsFactors = F)

#PGS_annot_second <- read.table("PGS_annot_sums.to_plot.gz", stringsAsFactors = F)

PGS_diff <- read.table("PGS_diff.lopez-isac.to_plot.gz", stringsAsFactors = F)
gmm_diff <- read.table("gmm_diff.lopez-isac.to_plot.gz", stringsAsFactors = F)
super_diff <- read.table("super_diff.lopez-isac.to_plot.gz", stringsAsFactors = F)
...
nonrisky_gmm <- read.table('gmm_nonrisky.ttest.lopez-isac.to_plot.gz', stringsAsFactors = F)
risky_gmm <- read.table('gmm_risky.ttest.lopez-isac.to_plot.gz', stringsAsFactors = F)
...
nonrisky_superclump <- read.table('super_nonrisky.ttest.lopez-isac.to_plot.gz', stringsAsFactors = F)
risky_superclump <- read.table('super_risky.ttest.lopez-isac.to_plot.gz', stringsAsFactors = F)
...
nonrisky_PGS <- read.table('PGS_nonrisky.ttest.lopez-isac.to_plot.gz', stringsAsFactors = F)
risky_PGS <- read.table('PGS_risky.ttest.lopez-isac.to_plot.gz', stringsAsFactors = F)
...
write.csv(PGS_tstats, "lopez-isac_PGStstat.csv")
write.csv(super_tstats, "lopez-isac_supertstat.csv")
write.csv(gmm_tstats, "lopez-isac_gmmtstat.csv")
